...
<body>
					...
					<td>
						<?php
							$str2='';
								...
								if ($u<>'') {$echo_menu.= '<a href="/gal.php">'.$line['value'].'</a> | ';} else {$echo_menu.=' | '.$line['value'];};
								findperant($u);
	...
	<?
		...
		echo '<img src="img/cut.jpg"  id="pas'.$u.'" class="imLink"/>'.$str2.'<br><br>';};
		echo '<input id="adK'.$u.'" class="inputAddKat link1" type="text" value="'.$line["name"].'" placeholder="Add"/><br>';
		}
