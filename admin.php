...
<body >
	...
	<a href="/">DanceFile</a> | 
<?
echo '<a href="/login.php?d=1">'.$_SESSION['login'].' log out</a> | <a href="/settings.php">Настройки</a>| <a href="/index.php?url=-1">Корзина</a>| <a href="/statistics.php">Статистика</a><br><br>';
?>
